...
def generate_html_report_with_screenshots(markers, screenshots_dict, output_path):
    ...
    try:
        ...
        if html_template and js_content:
            ...
            # Template files not found - this is an error condition
            print("[Screenshot] ERROR: Template files not found in templates/ directory")
            print("[Screenshot] Expected: report_template.html and report_script.js")
            return False
